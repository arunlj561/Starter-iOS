...
class User : NSObject, Mappable{
    ...
    class func loadUser(){
        PIVCManager.sharedInstance.currentUser = User(contentsOfFile: Utils.filePath(file: "/PivcUser").path)
    }
    
    
    func saveUser(){
        self.write(toFile: Utils.filePath(file: "/PivcUser").path, atomically: true)
    }
